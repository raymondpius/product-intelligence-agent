...
Product teams rely on dashboards and manual analysis to understand customer behavior.
...
2. Generates hypotheses about the dataset
3. Detects churn drivers
4. Identifies high performing and high risk cohorts
5. Explains visualizations in plain English
6. Recommends product interventions

This transforms analytics from **passive dashboards into active decision intelligence**.
...
2. The agent performs automated EDA
3. Charts and distributions are generated
4. The agent explains patterns in the data
5. Churn drivers and risky cohorts are detected
6. Product recommendations are generated
